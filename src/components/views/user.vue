  ...
  <div>
    ...
    >
      <el-form :model="formInfo" :rules="rules" ref="ruleForm">
        <el-form-item label="用户名称" prop="rolename" :label-width="formLabelWidth">
        ...
        <el-form-item label="用户类型" :label-width="formLabelWidth">
          ...
          <el-radio :disabled="formInfo.pid==0" v-model="formInfo.type" label="2">用户</el-radio>
        </el-form-item>
        <el-form-item
        ...
        <el-form-item v-if="formInfo.type == 2" label="用户地址" :label-width="formLabelWidth">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        pid: [{ required: true, message: "请选择所属用户", trigger: "blur" }]
      }
    };
  },
  methods: {
